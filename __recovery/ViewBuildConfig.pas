...
begin
  // 初始化按钮
  btnEditINIProperty.Enabled := False;
  btnRenameINIProperty.Enabled := False;
  btnDeleteINIProperty.Enabled := False;
...
begin
  // 初始化拖放功能
  sgINI.DragMode := dmAutomatic;
  tvJSON.DragMode := dmAutomatic;
end;
